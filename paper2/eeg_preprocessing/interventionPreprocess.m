% PREPROCESS EXERGAME AND ADHD INTERVENTION DATA
...
%% Define File Paths
interventionDatasetsDir = '../data/intervention_datasets/';
eeglab_path = 'C:\Users\ntasnim\Documents\eeglab2025.0.0\';
elc_file = append(eeglab_path,'plugins/dipfit/standard_BEM/elec/standard_1005.elc');
removed_channels_output_file = '../docs/intervention_removed_channels.csv';
preICA_path = '../preprocessed_eeg_data/session_2/intervention/preICA/';
postICA_path = '../preprocessed_eeg_data/session_2/intervention/postICA/';

%% Begin Preprocessing

% Gather List of Datasets
rawDataFiles = dir([interventionDatasetsDir '*.set']);
...
parfor dataset_index = 1:length(rawDataFiles) 
    ...
    EEG = pop_loadset('filename',loadName,'filepath',interventionDatasetsDir);
    ...
    EEG = pop_saveset(EEG, 'filename', dataName, 'filepath', preICA_path);
    ...
    EEG = pop_saveset(EEG, 'filename', dataName, 'filepath', postICA_path);
