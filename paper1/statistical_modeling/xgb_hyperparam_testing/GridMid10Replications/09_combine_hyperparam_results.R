...
# library(gridExtra)
# combined_sensitivity <- grid.arrange(grobs = sensitivity_plots, ncol = 3)
# 
# # Save using the plot argument
# ggsave("results/parameter_sensitivity.png", 
#        plot = combined_sensitivity,
